  ...
  for role in data.experience {
    ...
    for r in roles {
      ...
      let matching = r.achievements.filter(a =>
        a.tags.contains("terraform")
        or a.tags.contains("aws")
        or a.tags.contains("devops")
        or a.tags.contains("github-actions")
        or a.tags.contains("platform")
        or a.tags.contains("automation")
        or a.tags.contains("security")
        or a.tags.contains("infrastructure")
      )
