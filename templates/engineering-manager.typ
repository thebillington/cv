  ...
  for role in data.experience {
    ...
    for r in roles {
      ...
      let matching = r.achievements.filter(a =>
        a.tags.contains("management")
        or a.tags.contains("leadership")
        or a.tags.contains("coaching")
        or a.tags.contains("stakeholder-management")
        or a.tags.contains("delivery")
        or a.tags.contains("process-improvement")
        or a.tags.contains("team-building")
      )
